...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    //Her sınıftaki öğrenci sayılarını bulunuz
    String QUESTION_8 = "select o.sinif,count(o.sinif) from ogrenci o group by o.sinif;";
    @Query(value = QUESTION_8, nativeQuery = true)
    List<StudentClassCount> findStudentClassCount();
    //Her öğrencinin ad soya karşılığında okuduğu kitap sayısını getiriniz.
